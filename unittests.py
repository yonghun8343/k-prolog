...
#        self.assertIn("B = 2", stdout)
   ...
   def test_error_cases(self):
       ...
       self.assertTrue("ERROR" in stdout or "Error" in stdout or "error" in stdout or
                      "ERROR" in stderr or "Error" in stderr or "error" in stderr)
